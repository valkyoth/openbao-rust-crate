...
grep -q '^version = "2.1.3"$' Cargo.toml
grep -q 'base64-ng = { version = "2.0.1"' Cargo.toml
grep -q 'time = { version = "0.3.55"' Cargo.toml
grep -q 'openbao = { path = "..", version = "=2.1.3"' fuzz/Cargo.toml
grep -q 'openbao = { path = "../../..", version = "=2.1.3"' \
  tests/fixtures/reqwest-native-unification/Cargo.toml
grep -q 'Version: 2.1.3' release-notes/RELEASE_NOTES_2.1.3.md
grep -q '2.1.3 - 2026-08-08' CHANGELOG.md
