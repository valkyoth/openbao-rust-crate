...
check_grep 'version = "2.1.1"' Cargo.toml
...
check_grep 'version = "=2.1.1"' fuzz/Cargo.toml
check_grep 'version = "=2.1.1"' tests/fixtures/reqwest-native-unification/Cargo.toml
