...
check_file docs/SECURITY_MODEL.md
...
check_file compat/api-snapshots/2.6.1/documentation.json
check_file compat/api-snapshots/2.6.1/openapi.json
check_file compat/api-diffs/2.6.0--2.6.1.json
check_file compat/rendered-api-cross-checks/2.6.1-current.json
check_file compat/api-snapshots/2.6.2/documentation.json
check_file compat/api-snapshots/2.6.2/openapi.json
check_file compat/api-diffs/2.6.1--2.6.2.json
check_file compat/rendered-api-cross-checks/2.6.2-current.json
...
check_file tests/package_smoke.rs
...
check_file scripts/release_2_1_6_gate.sh
check_file scripts/release_2_1_7_gate.sh
...
check_grep 'version = "2.1.7"' Cargo.toml
...
check_grep 'version = "=2.1.7"' fuzz/Cargo.toml
check_grep 'version = "=2.1.7"' tests/fixtures/reqwest-native-unification/Cargo.toml
...
check_grep 'Client::try_with_token.*transfers the token' docs/SECURITY_MODEL.md
check_grep 'not automatically locked' README.md
...
check_grep 'scripts/release_2_1_6_gate.sh' release-notes/RELEASE_NOTES_2.1.6.md
check_grep 'scripts/release_2_1_7_gate.sh' release-notes/RELEASE_NOTES_2.1.7.md
...
check_grep '2.1.6 - Secret-Bearing HTTP Buffer Hardening' docs/RELEASE_PLAN.md
check_grep '2.1.7 - Sanitization Secrecy Provider Migration' docs/RELEASE_PLAN.md
...
check_grep 'Version: 2.1.6' release-notes/RELEASE_NOTES_2.1.6.md
check_grep 'Release date: 2026-09-06' release-notes/RELEASE_NOTES_2.1.6.md
check_grep 'Version: 2.1.7' release-notes/RELEASE_NOTES_2.1.7.md
check_grep 'Release date: 2026-09-06' release-notes/RELEASE_NOTES_2.1.7.md
...
if [ "$readme_lines" -gt 600 ]; then
  echo "README exceeds the 600-line crates.io landing-page limit: $readme_lines" >&2
  exit 1
fi

security_bytes="$(wc -c < SECURITY.md)"
if [ "$security_bytes" -gt 8192 ]; then
  echo "packaged SECURITY.md exceeds the 8 KiB policy limit: $security_bytes bytes" >&2
  exit 1
fi
